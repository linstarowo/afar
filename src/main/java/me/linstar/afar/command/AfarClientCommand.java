...
public class AfarClientCommand {
    ...
    public static void showDatabaseInfo(CommandSourceStack source){
        ...
        source.sendSystemMessage(Component.literal("数据库大小: ").withStyle(ChatFormatting.GRAY).append(Component.literal(String.valueOf(dataSize) + "MB").withStyle(ChatFormatting.GREEN)));
    }
